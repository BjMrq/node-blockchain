...
const blockchain_1 = require("../src/domains/blockchain/blockchain");
describe('Blockchain', () => {
    let blockchain;
    beforeAll(() => {
    ...
    describe('hashBlock', () => {
        it('create hash for a block', async () => {
            ...
            expect(await blockchain['hashBlock']('12323', [createdTransaction.transaction, createdTransaction2.transaction], 1)).toStrictEqual('1ee83d6f28124db9715c4ab4723317a4cbb776ece432d84c53c02a145f517b32');
        });
    });
    describe('proofOfWork', () => {
        it('find hash for new block depending of difficulty', async () => {
            ...
            expect(await blockchain.proofOfWork('12323', [createdTransaction.transaction, createdTransaction2.transaction])).toStrictEqual({ hash: '02ef317d93e932a8d1429386984c724020596800294bda1310c643012f6ab192', nonce: 7 });
        });
    });
    describe('isValidBlock', () => {
        it('verify that a block is valid', async () => {
            ...
            expect(await blockchain.isValidBlock({ ...newBlock, previousBlockHash: `0${previousBlockHash}` })).toStrictEqual(false);
        });
    });
});
